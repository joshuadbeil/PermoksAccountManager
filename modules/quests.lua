...
local labelRows = {
	korthia_dailies = {
		IDs = {
			...
			63934,63935,63936,63937,63950,63954,63955,63956,63957,63958,
			63959,63960,63961,63962,63963,63964,63965,63989,64015,64016,
			64017,64043,64065,64070,64080,64089,64101,64103,64104,64129,
			64166,64194,64432
		},
	...
	transport_network_dailies = {
		IDs = {
			60153,60175,60188,62263,62296,62382,62453,62459,62465,62466,
			62606,62607,62608,62610,62611,62614,62615
		},
		hideOption = true,
		type = 'quest',
		questType = 'daily',
	...
	relic_creatures = {
		IDs = {
			64341,64342,64343,64344,64747,64748,64749,64750,64751,64752,
	...
	maw_dailies = {
		IDs = {
			60622,60646,60732,60762,60775,60902,61075,61079,61088,61103,
			61104,61334,61765,62214,62234,62239,63031,63038,63039,63040,
			63043,63045,63047,63050,63062,63069,63072,63100,63179,63206,
		},
		label = L['Maw Dailies'],
		type = 'quest',
		questType = 'daily',
	...
	dungeon_quests = {
		IDs = {
			...
			60252,60253,60254,60255,60256,60257
		},
	...
	maw_souls = {
		IDs = {
			61331,61332,61333,61334,62858,62859,62860,62861,62862,62863,
	...
	zereth_mortis_dailies = {
		IDs = {
			64579,64592,64717,64785,64854,64964,64977,65033,65072,65096,
			65142,65177,65226,65255,65256,65264,65265,65268,65269,65325,
			65326,65362,65363,65364,65445
		},
		label = 'Dailies',
		type = 'quest',
		questType = 'daily',
	...
	zereth_mortis_wqs = {
		IDs = {
			64960,64974,65081,65089,65102,65115,65117,65119,65230,65232,
			65234,65244,65252,65262,65402,65403,65405,65406,65407,65408,
			65409,65410,65411,65412,65413,65414,65415,65416,65417
		},
		label = 'ZM WQs',
		type = 'quest',
		questType = 'daily',
	...
	puzzle_caches = {
		IDs = {
			64972,65091,65092,65093,65094,65314,65315,65316,65317,65318,
			65319,65320,65321,65322,65323
		},
		label = 'Puzzle Caches',
		type = 'quest',
		questType = 'daily',
	...
	aiding_the_accord = {
		IDs = {
			70750,72068,72373,72374,72375,75259,75859,75860,75861,77254,
			77976,78446,78447,78861,80385,80386,80388,80389
		},
	...
	marrukai_camp = {
		IDs = {
			65784,65789,65792,65796,65798,66698,66711,67034,67039,67222,
			67605,70210,70279,70299,70352,70701,70990,71241
		},
		label = 'Maruukai Camp',
		type = 'quest',
		questType = 'biweekly',
